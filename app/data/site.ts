...
export const supportSections = [
  {
    ...
    rows: [
      {
        name: l('SDK 主程序', 'SDK Package'),
        category: l('SDK 资源', 'SDK'),
        description: l('基础开发资源、示例工程与集成说明。', 'Base resources, examples and integration notes.'),
        status: l('目录预留', 'Directory reserved'),
      },
      {
        name: l('快速上手指南', 'Quick Start Guide'),
        category: l('接入指南', 'Guide'),
        description: l('从环境准备到首次验证的开发路径。', 'Development path from environment setup to first validation.'),
        status: l('可咨询获取', 'Available on request'),
      },
      {
        name: l('版本说明', 'Release Notes'),
        category: l('版本信息', 'Release'),
        description: l('记录 SDK 更新范围与兼容性信息。', 'SDK update scope and compatibility notes.'),
        status: l('持续更新', 'In progress'),
      },
    ],
  ...
  },
  {
    ...
    rows: [
      {
        name: l('烧录工具', 'Flashing Tool'),
        category: l('烧录', 'Flashing'),
        description: l('用于固件下载与烧录流程验证。', 'For firmware download and flashing workflow validation.'),
        status: l('目录预留', 'Directory reserved'),
      },
      {
        name: l('调试助手', 'Debug Assistant'),
        category: l('调试', 'Debug'),
        description: l('用于连接状态、日志与通信问题定位。', 'For connection state, logs and communication issue diagnosis.'),
        status: l('可咨询获取', 'Available on request'),
      },
      {
        name: l('验证工具', 'Validation Tool'),
        category: l('验证', 'Validation'),
        description: l('用于功能、稳定性与交付前检查。', 'For function, stability and pre-delivery checks.'),
        status: l('持续更新', 'In progress'),
      },
    ],
  ...
  },
  {
    ...
    rows: [
      {
        name: l('产品资料', 'Product Documents'),
        category: l('产品资料', 'Product'),
        description: l('规格、参数与产品选型相关资料。', 'Specifications, parameters and selection documents.'),
        status: l('可咨询获取', 'Available on request'),
      },
      {
        name: l('参考设计', 'Reference Design'),
        category: l('参考设计', 'Reference'),
        description: l('硬件与软件集成参考资料。', 'Hardware and software integration references.'),
        status: l('目录预留', 'Directory reserved'),
      },
      {
        name: l('流程文件', 'Process Files'),
        category: l('流程文件', 'Process'),
        description: l('开发、验证与交付阶段的流程资料。', 'Development, validation and delivery process files.'),
        status: l('持续更新', 'In progress'),
      },
    ],
  ...
  },
  {
    ...
    rows: [
      {
        name: l('蓝牙连接', 'Bluetooth Connectivity'),
        category: l('连接与协议', 'Connectivity'),
        description: l('围绕配对、连接、传输与协议适配的问题交流。', 'Pairing, connection, transfer and protocol adaptation topics.'),
        status: l('筹备中', 'Preparing'),
      },
      {
        name: l('硬件设计', 'Hardware Design'),
        category: l('硬件设计', 'Hardware'),
        description: l('围绕射频、电源、天线和硬件集成的问题交流。', 'RF, power, antenna and hardware integration topics.'),
        status: l('筹备中', 'Preparing'),
      },
      {
        name: l('固件与调试', 'Firmware & Debug'),
        category: l('固件与调试', 'Firmware'),
        description: l('围绕固件集成、日志分析与功能验证的问题交流。', 'Firmware integration, logs and validation topics.'),
        status: l('筹备中', 'Preparing'),
      },
    ],
  ...
  },
  {
    ...
    rows: [
      {
        name: l('如何开始产品选型？', 'How do I start product selection?'),
        category: l('产品选型', 'Selection'),
        description: l('准备产品形态、连接方式、功耗目标和量产计划。', 'Prepare product form, connection mode, power target and production plan.'),
        status: l('建议先咨询', 'Consult first'),
      },
      {
        name: l('如何申请 SDK 或开发资料？', 'How do I request SDK or documents?'),
        category: l('资料获取', 'Resources'),
        description: l('说明目标产品、项目阶段和所需资料类型。', 'Share target product, project stage and requested resource type.'),
        status: l('联系获取', 'Contact required'),
      },
      {
        name: l('开发过程中遇到调试问题怎么办？', 'What if I meet a debugging issue?'),
        category: l('开发支持', 'Development'),
        description: l('提交设备型号、复现步骤、日志或现象描述。', 'Send device model, reproduction steps, logs or symptom description.'),
        status: l('技术支持', 'Support'),
      },
    ],
    faqs: [
      {
        question: l('资料是否支持直接下载？', 'Are downloads available directly?'),
        answer: l(
          '当前静态原型保留资料目录与状态展示，正式接入后可绑定真实下载或权限申请流程。',
          'This static prototype reserves resource entries and statuses. Real downloads or permission requests can be connected later.',
        ),
      },
      {
        question: l('技术论坛现在可以发帖吗？', 'Can I post in the forum now?'),
        answer: l(
          '论坛目前作为筹备中的信息入口，后续可接入真实论坛系统或工单系统。',
          'The forum is currently a prepared information entry and can later connect to a real forum or ticket system.',
        ),
      },
    ],
